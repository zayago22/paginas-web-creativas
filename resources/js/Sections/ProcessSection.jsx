        ...
        <section className="py-28" id="proceso">
            <div className="max-w-[1200px] mx-auto px-6">
                <Reveal>
                    ...
                    <p className="text-[var(--text-secondary)] text-lg max-w-[600px] leading-relaxed">Tres pasos simples para tener tu página web profesional lista.</p>
                </Reveal>
                <div className="grid md:grid-cols-3 gap-8 mt-16">
                    {[
                        ...
                        <Reveal key={i} delay={i * 120}>
                            <div className="group p-10 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl hover:border-[#0090ff]/20 hover:-translate-y-1 hover:shadow-[0_20px_60px_var(--shadow-color)] transition-all relative overflow-hidden">
