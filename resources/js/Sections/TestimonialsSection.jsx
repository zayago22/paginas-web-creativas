                ...
                <div className="grid md:grid-cols-3 gap-7 mt-16">
                    {testimonials.map((t, i) => (
                        <Reveal key={t.id} delay={i * 120}>
                            <div className="text-left p-8 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl hover:border-[#0090ff]/15 hover:-translate-y-1 transition-all">
                                <div className="flex gap-0.5 mb-4 text-[#feca57]">{'★'.repeat(t.rating)}</div>
                                <p className="text-sm text-[var(--text-secondary)] leading-[1.8] italic mb-5">"{t.content}"</p>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[var(--text-muted)]">{t.client_role}</p>
                                    </div>
                                </div>
                            </div>
                        </Reveal>
