        ...
        <AppLayout>
            ...
            <section className="pt-40 pb-12 text-center">
                <div className="max-w-[1100px] mx-auto px-6">
                    ...
                    <p className="text-lg text-[#94a3b8] max-w-[560px] mx-auto leading-relaxed">
                        Comprime, edita, convierte y optimiza directamente en tu navegador. Nada se sube a ningún servidor.
                    </p>

                    <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm text-[#94a3b8]">
            ...
            <section className="pb-28">
                <div className="max-w-[1100px] mx-auto px-6">
                                ...
                                {tools.map(tool => (
                                    tool.url ? (
                                        <Link key={tool.id} href={tool.url}
                                              className="group flex items-start gap-4 p-6 bg-[#141d2f] border border-white/[0.06] rounded-2xl hover:border-[#0090ff]/20 hover:-translate-y-1 hover:shadow-[0_16px_50px_rgba(0,0,0,.3)] transition-all relative">
                                        ...
                                        <div key={tool.id} className="flex items-start gap-4 p-6 bg-[#141d2f] border border-white/[0.06] rounded-2xl opacity-50 relative">
                    ...
                    {/* CTA */}
                    <div className="mt-12 p-12 bg-[#141d2f] border border-white/[0.06] rounded-2xl text-center">
                        <h2 className="text-xl font-extrabold mb-2">¿Necesitas una página web profesional?</h2>
                        <p className="text-[#94a3b8] mb-6">Diseñamos sitios web que generan clientes. Desde $8,999 MXN.</p>
